		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post">
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please an actor">
					...
					<input class="input100" type="text" name="actors2" placeholder="Write second actor">
				</div>
				<div class="wrap-input100 validate-input bg1" data-validate="Please an actor">
					<span class="label-input100">Third Actor  *</span>
					<input class="input100" type="text" name="actors3" placeholder="Write third actor ">
				</div>
				<div class="wrap-input100 validate-input bg1" data-validate="Please an actor">
					<span class="label-input100">Director  *</span>
					<input class="input100" type="text" name="director" placeholder="Write director ">
				</div>
